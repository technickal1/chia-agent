import {G1Element, Optional, str, uint32, uint8} from "rolls-agent/src/api/rolls/types/_python_types_";
...
import {Program} from "rolls-agent/src/api/rolls/types/blockchain_format/program";
