...
import {bool, G1Element, str, uint64} from "rolls-agent/src/api/rolls/types/_python_types_";
import {CoinSpend} from "rolls-agent/src/api/rolls/types/coin_spend";
import {PoolState} from "rolls-agent/src/api/rolls/pools/pool_wallet_info";
