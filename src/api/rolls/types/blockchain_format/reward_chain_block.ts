...
import {VDFInfo} from "rolls-agent/src/api/rolls/types/blockchain_format/vdf";
import {bool, G2Element, Optional, uint128, uint32, uint8} from "rolls-agent/src/api/rolls/types/_python_types_";
