import {G2Element, Optional, uint32, uint64, uint8} from "rolls-agent/src/api/rolls/types/_python_types_";
...
import {PoolTarget} from "rolls-agent/src/api/rolls/types/blockchain_format/pool_target";
